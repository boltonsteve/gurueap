...
<SvelteSeo
    ...
    description="Demonstrating the correct use of the contrasting signal 'on the contrary'"
/>

<div class="mb-3 mw-500">

    <img src="../img/little-miss-contrary.png" class="img-fluid mx-auto w-25" alt="little miss contrary" style="width:300px;">

    <h1>On the contrary</h1>

    <div class="alert alert-danger font-italic mb-2">My dog is friendly. <span class="font-weight-bold font-italic text-danger">On the contrary</span> my neighbour's dog is aggressive.</div>
