...
<div class="mb-3 mw-500">
    ...
    <p><b><i>Items</i></b> in parallel structures include:</p>
    <ul>
        <li>noun phrases</li>
        <li>verb phrases</li>
    ...
    <p><b><i>Parallel</i></b> means that all of the <b><i>items</i></b> are the same type - <i>all</i> nouns, <i>all</i> verb phrases, etc.</p>

<h3>Parallel nouns</h3>
...
<ul>
    <li>conflicts in existing cultural values</li>
    <li>misinterpretation</li>
    <li>loss of originality in cultural identity</li>
</ul>
...
<p>Accurate <b><i>parallel structures</i></b> can help to increase your <b>IELTS</b> score for <b>GRA</b> (they're 'structural'), <b>LR</b> (noun phrases are probably the most common item), and even <b>CC</b> (non-parallel structures are difficult to understand).</p>

<p>Ha! There - I just used <span class="uli">a parallel structure built from nouns</span> (<b>GRA</b>, <b>LR</b>, <b>CC</b>)!</p>
