...
<div class="mw-500 mb-3">
    ...
    <img src="/img/chomsky.png" class="img-fluid mx-auto mt-1" alt="chomsky">

    <h1>Reporting verbs: tenses</h1>

    <div class="alert alert-danger font-italic">Chomsky (2023) <span class="font-weight-bold text-danger">argued</span> that grammar monopoly is an effective way to highlight first language interference.</div>
