...
<div class="mb-3 mw-500">
    ...
    <p>To make your writing 'flow', so that pieces of information connect together well, use <b><i>it</i></b> only when <b><i>it</i></b> refers back to the subject of the previous sentence.</p>
    ...
    <p>After re-reading the text two or three times we see the writer is using <b><i>it</i></b> to refer to 'the things people want to buy', which is rather confusing since 'the things people want to buy' is not the subject of the previous sentence and it is neither singular countable nor uncountable.</p>

    <p>This kind of mismatch interrupts the flow of information in the text and brings down your score for coherence and cohesion in IELTS writing, as well as your score for fluency in IELTS speaking.</p>
