...
<div class="mw-500 mb-3">
    ...
    <h3><b><i>Staff</i></b> - singular countable noun</h3>

    <p>If you use <b><i>staff</i></b> as a singular countable noun, then you are probably not referring to someone who is a worker.</p>

    <p>Used as a singular countable noun, <b><i>a staff</i></b> is a kind of stick with certain features and functions:</p>
    ...
    <ul>
        ...
        <li>used by someone with special powers, for example a wizard</li>
        <li>often used in specialised fighting, like kung fu</li>
    ...
    <h3><b><i>Staff</i></b> - plural countable <span class="uli">without</span> 's'</h3>
    ...
    <h3><b><i>Staff</i></b> - <span class="uli">uncountable</span></h3>
    ...
    <p>Again, this use of <b><i>staff</i></b> (uncountable) is extremely rare and I suggest <span class="uli">not</span> using it in IELTS.</p>
