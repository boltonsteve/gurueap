...
<div class="mb-3 mw-500">
    ...
    <div class="alert alert-danger font-italic">In my spare time I <span class="font-weight-bold text-danger">usually</span> go out with my friends.</div>

    <p>This is grammatically correct. However, if you're talking about something you do <i>regularly</i> or <i>habitually</i> then <span class="uli">present simple tense</span> is all you need:</p>
    ...
    <div class="alert alert-success">
        ...
        <p class="small mb-0">(You don't <b><i>usually</i></b> have an IELTS interview..)</p>
    </div>
