...
<div class="mb-3 mw-500">
    ...
    <img src="/img/condoms.png" alt="condoms" style="float:right;width:120px;">
    <p class="mb-2">Why is the IELTS examiner confused by this? Because it creates in the mind of the examiner a kind of impossible cartoon image showing two condoms having sex in such a way that the female condom will not become pregnant!</p>
    ...
    <div class="alert alert-success font-italic mt-1">Everybody knows that condoms can <span class="font-weight-bold text-success">prevent</span> pregnancy.</div>
