<script>
    ...
    let incoming = `<div class="my-text">Some students perform badly in IELTS because they are under an unusual amount of stress. IELTS is particularly stressful because [if students do not achieve their target score they may not be able to continue with their scholarships|Why?]. The kind of stress caused by IELTS can lead to [anxiety|What?], and [depression|What?]. However, it is possible to overcome this stress so that [a satisfactory score can be achieved without too much angst|So that what?], as follows.
...
In conclusion, IELTS anxiety can be reduced easily, by meditating and by living 'cleanly' as the test date approaches. As long as habits such as these are developed, [stress will at least be controlled|What will happen?] and [IELTS band scores may increase|What else will happen?].</div>`;
