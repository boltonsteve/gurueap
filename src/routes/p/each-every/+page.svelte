...
<ul class="font-italic">
    <li><span class="font-weight-bold text-success">Every</span> field is going through rapid change.</li>
    <li>The crowds were getting worse <span class="font-weight-bold text-success">every</span> minute!</li>
    <li>These days every genre is using <span class="font-weight-bold text-success">every</span> sound.</li>
</ul>

<p><b><i>Every</i></b> + field, minute, genre, sound (singular, even though we're thinking about all field<span class="uli">s</span>, minute<span class="uli">s</span>, genre<span class="uli">s</span>, sound<span class="uli">s</span>!)</p>

<p>I know. It's crazy. And the same applies to <b><i>each</i></b>:</p>

<ul class="font-italic">
    <li><span class="font-weight-bold text-success">Each</span> correct answer is worth 10 points.</li>
    <li><span class="font-weight-bold text-success">Each</span> room contains high speed wireless internet access.</li>
